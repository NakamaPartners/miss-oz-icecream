  ...
  return (
    <footer id="contact" className="bg-[var(--cocoa)] text-[var(--cream)] pt-[120px] pb-[44px] px-[6vw] relative mt-[80px]">
      ...
      <span
        ...
        style={{ fontFamily: "'Yellowtail', cursive", fontSize: 36 }}
      >
      ...
      <div className="flex justify-between flex-wrap gap-[34px] border-t border-[rgba(242,225,194,0.3)] pt-[34px] text-[16px]">
        ...
        <div className="min-w-[260px] flex-1 max-w-[340px]">
          ...
          {submitted ? (
            ...
            <>
              ...
              <button
                ...
                className="clickable w-full py-[12px] px-[14px] bg-transparent border-2 border-[var(--gold-hi)] text-[var(--cream)] text-[14px] tracking-[2px] uppercase font-semibold hover:bg-[var(--gold-hi)] hover:text-[var(--cocoa)] transition-colors cursor-none"
                style={{ fontFamily: "'EB Garamond', serif" }}
              >
                Subscribe
              </button>
          ...
          <div className="flex gap-[14px] mt-[20px]">
            {/* Facebook */}
            <a href="#" aria-label="Facebook" className="w-[36px] h-[36px] rounded-full border border-[rgba(242,225,194,0.4)] flex items-center justify-center text-[#EFE2CE] hover:border-[var(--gold-hi)] hover:text-[var(--gold-hi)] transition-colors cursor-none">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
            </a>
            {/* Twitter / X */}
            <a href="#" aria-label="Twitter" className="w-[36px] h-[36px] rounded-full border border-[rgba(242,225,194,0.4)] flex items-center justify-center text-[#EFE2CE] hover:border-[var(--gold-hi)] hover:text-[var(--gold-hi)] transition-colors cursor-none">
            ...
            {/* Instagram */}
            <a href="#" aria-label="Instagram" className="w-[36px] h-[36px] rounded-full border border-[rgba(242,225,194,0.4)] flex items-center justify-center text-[#EFE2CE] hover:border-[var(--gold-hi)] hover:text-[var(--gold-hi)] transition-colors cursor-none">
